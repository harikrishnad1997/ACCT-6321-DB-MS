...
CONSTRAINT INV_CK1 CHECK (INV_DATE > '01-JAN-2014'))
...
INSERT INTO PRODUCT
VALUES ('11QER/31','Power painter, 15 psi., 3-nozzle','11-03-15',8,5,109.99,0.00,21225)

INSERT INTO PRODUCT
VALUES ('13-Q2/P2','7.25-in. pwr. saw blade','12-13-15',32,15,14.99, 0.05,21225)
...
INSERT INTO PRODUCT
VALUES ('BRT-345','Titanium drill bit', '10-18-15', 75, 10, 4.50, 0.06, NULL)
...
UPDATE PRODUCT
SET    P_SALECODE = '2'
WHERE  P_INDATE < '25-DEC-2015'

UPDATE PRODUCT
SET    P_SALECODE = '1'
WHERE  P_INDATE >= '16-JAN-2016'
AND    P_INDATE <  '10-FEB-2016'
