...
insert into orders values (939, '11/11/2015', NULL , NULL , 'CART', 8801, '(4) Remanuf toners', 0, 215.8, 5, '11/14/2013', 'REC', 'LAB');
insert into orders values (940, '12/25/2015', NULL, '245650', 'CART', '210559', '(1) HyperCam software', 0, 30, 5, NULL, 'OPEN', 'LAB');
insert into orders values (941, '12/31/2015', NULL, '24650', 'DELL', '171114564', '(2) 32MB SIMM and DIMM for Dell @ Lab', 0, 110.4, 16, '01/03/2014', 'REC', 'LAB');
insert into orders values (942, '01/01/2016', NULL, NULL, 'LSREX', '8893', '(5) Remanuf', 0, 269.75, 17, '01/04/2014', 'REC', 'LAB');
insert into orders values (943, '01/05/2016', NULL, 245650, 'CART', 'C#638708', '(2) 32MB EDO SIMMS for Vektron NT test', 7.35, 79.33, 10, NULL, 'OPEN', 'LAB');
insert into orders values (944, '01/10/2016', NULL, NULL , 'DELL', '8908', '(1) HP4 new drum, (2) HP4 toner refill, (4) HP4 toner+drum', 0, 443.5, 5, '01/11/2014', 'REC', 'LAB');
insert into orders values (945, '01/10/2016', NULL , 245650, 'CART',NULL , '(10) 32MB EDO RAM SIMMS', 12, 372, 6, NULL, 'OPEN', 'LAB');
insert into orders values (946, '01/12/2016', NULL, NULL, 'COEX', '149363', '(10) 8 1/2 x 11 Laser Paper Boxes', 0, 193.8, 17, '01/13/2014', 'REC', 'LAB');
insert into orders values (947, '01/20/2016', NULL, NULL, 'DELL', '8842', '(4) Remanuf Toners', 0, 215.8, 7, '01/22/2014', 'REC', 'LAB');
insert into orders values (950, '01/21/2016', NULL, NULL, 'LSREX', '8856', '(2) Toner w/drum', 0, 167.8, 5, '01/22/2014', 'REC', 'LAB');
insert into orders values (951, '01/24/2016', NULL, NULL, 'CART', '8993', '(7) Remanf toners, (1) Toner w/ drum replace', 0, 431.6, 13, '01/26/2014', 'REC', 'LAB');
