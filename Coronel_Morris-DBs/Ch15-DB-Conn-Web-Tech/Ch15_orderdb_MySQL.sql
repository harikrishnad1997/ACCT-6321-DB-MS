...
insert into orders values (939, '2015-11-11', NULL , NULL , 'CART', 8801, '(4) Remanuf toners', 0, 215.8, 5, '2013-11-14', 'REC', 'LAB');
insert into orders values (940, '2015-12-25', NULL, '245650', 'CART', '210559', '(1) HyperCam software', 0, 30, 5, NULL, 'OPEN', 'LAB');
insert into orders values (941, '2015-12-31', NULL, '24650', 'DELL', '171114564', '(2) 32MB SIMM and DIMM for Dell @ Lab', 0, 110.4, 16, '2014-01-03', 'REC', 'LAB');
insert into orders values (942, '2016-01-01', NULL, NULL, 'LSREX', '8893', '(5) Remanuf', 0, 269.75, 17, '2014-01-04', 'REC', 'LAB');
insert into orders values (943, '2016-01-05', NULL, 245650, 'CART', 'C#638708', '(2) 32MB EDO SIMMS for Vektron NT test', 7.35, 79.33, 10, NULL, 'OPEN', 'LAB');
insert into orders values (944, '2016-01-10', NULL, NULL , 'DELL', '8908', '(1) HP4 new drum, (2) HP4 toner refill, (4) HP4 toner+drum', 0, 443.5, 5, '2014-01-11', 'REC', 'LAB');
insert into orders values (945, '2016-01-10', NULL , 245650, 'CART',NULL , '(10) 32MB EDO RAM SIMMS', 12, 372, 6, NULL, 'OPEN', 'LAB');
insert into orders values (946, '2016-01-12', NULL, NULL, 'COEX', '149363', '(10) 8 1/2 x 11 Laser Paper Boxes', 0, 193.8, 17, '2014-01-13', 'REC', 'LAB');
insert into orders values (947, '2016-01-20', NULL, NULL, 'DELL', '8842', '(4) Remanuf Toners', 0, 215.8, 7, '2014-01-22', 'REC', 'LAB');
insert into orders values (950, '2016-01-21', NULL, NULL, 'LSREX', '8856', '(2) Toner w/drum', 0, 167.8, 5, '2014-01-22', 'REC', 'LAB');
insert into orders values (951, '2016-01-24', NULL, NULL, 'CART', '8993', '(7) Remanf toners, (1) Toner w/ drum replace', 0, 431.6, 13, '2014-01-26', 'REC', 'LAB');
